...
modals_test_original = [
    ...
    {'You ___ be polite with your teachers and parents.': ['must', 'should to', 'do not have to', 'have to']},
    ...
    {'She ___ wake up and go to school every day at 7 am.': ['has to', 'have to', 'should to', 'musts']},
    {'She ___ write the test tommorow.': ['does not have to', 'should not', 'must not', 'have to']},
    {'My parents ___ go to supermarket tommorow.': ['have to', 'has to', 'must', 'should not']},
    {'I ___ get up everyday and go to school.': ['have to', 'has to', 'should not', 'must not']},
    {'My sister ___ tidy up her room.': ['has to', 'have to', 'must not', 'should not']},
    {'Jane ___ do her homework.': ['has to', 'have to', 'must not', 'should not']},
